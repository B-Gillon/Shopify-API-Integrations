...
Retrieve - Ability to GET a list of locations in the Shopify webstore
Connect - Allows you to connect a product to a location, one location at a time.
Disconnect - Allows you to disconnect a product from a location, one location at a time.  This would make sense if an product will no longer be shipping from a location.
